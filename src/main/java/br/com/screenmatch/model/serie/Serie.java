...
// Mapeia como entidade
@Entity
// Permite trocar o nome da tabela, geralmente é igual da classe
// Nos atributos usaria collumn
@Table(name = "series")
public class Serie {
    // Define o ID e setta como auto increment
    @Id
    ...
    // Ordena a partir desse atributo
